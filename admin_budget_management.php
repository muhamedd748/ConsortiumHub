            ...
            <form method="POST" action="admin_fields_handler.php" onsubmit="event.preventDefault(); saveEditBudgetData();">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="0.01" id="edit_budget_data_view_actual_plus_forecast" class="form-input bg-gray-100" readonly>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700 font-medium mb-2">
                            <i class="fas fa-percentage mr-2"></i>Variance %
                        </label>
                        <input type="number" step="0.01" id="edit_budget_data_view_variance_percentage" class="form-input bg-gray-100" readonly>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700 font-medium mb-2">
                            <i class="fas fa-certificate mr-2"></i>Certified
